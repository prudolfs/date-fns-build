...
function format(dirtyDate, dirtyFormatStr, dirtyOptions) {
  ...
  var result = formatStr.match(longFormattingTokensRegExp).map(function (substring) {
    ...
    if (formatter) {
      if (!options.useAdditionalWeekYearTokens && (0, _index17.isProtectedWeekYearToken)(substring)) {
        (0, _index17.throwProtectedError)(substring);
      }
      if (!options.useAdditionalDayOfYearTokens && (0, _index17.isProtectedDayOfYearToken)(substring)) {
        (0, _index17.throwProtectedError)(substring);
      }
